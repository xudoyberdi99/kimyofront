<template>
  <div>
    <img
      class="w-100"
      src="@/assets/istockphoto-1391054420-612x612.jpg"
      alt="adead"
    />
    <div class="single-content">
      ...
      <p>
        ...
        doloribus ducimus eligendi id illum, laboriosam libero neque obcaecati
        quaerat voluptatem? Animi blanditiis incidunt quo unde veniam! Aliquam
        amet aspernatur atque aut autem blanditiis delectus dolor dolorum
        eligendi esse eveniet excepturi expedita explicabo facere facilis illo,
        impedit ipsam laborum libero magni maiores modi nemo nesciunt quae
        quaerat ratione rem repudiandae sapiente sequi sunt ullam vero
        voluptate, voluptates! Beatae molestiae nemo numquam totam! At magnam
        necessitatibus nemo numquam odio, repellat repellendus unde. Dolorem hic
        ipsa itaque iure magni omnis praesentium recusandae sapiente sed unde.
        Aliquam aspernatur et itaque, modi odit quas repellendus. provident quae
        quo sequi sint!
      </p>
    </div>
    <div>
      <div class="share d-flex justify-content-between">
        <div class="d-flex">
          ...
          <a href="javascript:void(0)" class="share-network-telegram"
            ><svg
              width="20"
              height="16"
              viewBox="0 0 20 16"
