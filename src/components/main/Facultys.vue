  ...
  <div class="container mb-5">
      ...
      <div class="row">
          <div class="col-md-4 groups-item">
              ...
              <hr>
              <ul class="lists">
                  <li class="list-item"><i class="fa-solid fa-check mr-2"></i><span class="text">Lorem ipsum dolor sit amet, consectetur.</span></li>
                  <li class="list-item"><i class="fa-solid fa-check"></i><span class="text">Lorem ipsum dolor sit amet, consectetur.</span></li>
                  <li class="list-item"><i class="fa-solid fa-check"></i><span class="text">Lorem ipsum dolor sit amet, consectetur.</span></li>
                  <li class="list-item"><i class="fa-solid fa-check"></i><span class="text">Lorem ipsum dolor sit amet, consectetur.</span></li>
                  <li class="list-item"><i class="fa-solid fa-check"></i><span class="text">Lorem ipsum dolor sit amet, consectetur.</span></li>
              </ul>
